...
function RegisterForm() {
    ...
    return (
        <div className="bg-amber-50 rounded-md shadow p-6 w-full max-w-md flex flex-col gap-4">
            ...
            <Input type="text" placeholder="Nombre completo . . ." value={name} onChange={e => setName(e.target.value)} autoComplete="off" />
            <Input type="text" placeholder="Username . . ." value={username} onChange={e => setUsername(e.target.value)} autoComplete="off" />
            <Input type="text" placeholder="Correo electrónico @ . . ." value={email} onChange={e => setEmail(e.target.value)} autoComplete="off" />
