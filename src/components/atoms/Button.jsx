...
function Button({ children, onClick, variant = "primary", type = "button", disabled = false, className = "" }) {
    const variants = {
        primary: "bg-[#ff7226] text-amber-50 rounded-xl py-2 font-semibold hover:bg-[#f4895a] cursor-pointer disabled:opacity-50 disabled:cursor-not-allowed",
        ...
        outline: "border border-[#ff7226] text-[#ff7226] rounded-xl py-2 font-semibold hover:bg-orange-50 cursor-pointer disabled:opacity-50 disabled:cursor-not-allowed",
    };
